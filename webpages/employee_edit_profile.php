...
$successMsg="";
$errMsg="";
if(isset($_SESSION['isAdmin']) && $_SESSION['isAdmin']=="no"){
...
<head>
    ...
    <link rel="stylesheet" href="../stylesheets/employee_edit_profile.css">
...
<script>
    ...
    {
        console.log("Here");
        $("#suc-msg").animate({opacity:'0'},3000,function(){
            ...
            <div class="panel-body" id="reg-form">
                <form class="form-horizontal" method="POST" action="<?php echo $_SERVER['PHP_SELF'];?>" >
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                            <label class="radio-inline" id="gender-male" ><input type="radio" name="gender" <?php if($gender==="male"){ echo 'checked="checked"';} ?> value="1" >&nbspMale</label>
